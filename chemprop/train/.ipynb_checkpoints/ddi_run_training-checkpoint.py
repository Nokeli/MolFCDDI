...
def ddi_run_training(args: Namespace, pretrain: bool, logger: Logger = None) -> List[float]:
    ...
    train_class_weights = get_class_weights(train_data, n_classes=86)
    valid_class_weights = get_class_weights(val_data, n_classes=86)
    test_class_weights = get_class_weights(test_data, n_classes=86)
